#!/bin/bash
#
# Completion Harness — task-DoD walking skeleton: the STUB /done.
#
# Part of the dod/ skeleton (issue #11 / ADR-0001). This is the skeleton's
# stand-in for the real Definition-of-Done checklist. The real /done — config
# detect, tests with a before/after checkpoint, app startup, task_checks, a
# fresh-agent changeset review, fix loop — is DELIBERATELY OUT OF SCOPE here:
# "The expensive middle already works and is not what's being proven" (issue,
# "Scope of this issue"). What IS being proven is the lifecycle around it:
...
# "the model ran /done"; the headless trial and test-dod.sh invoke this to
# simulate that step.
#
