...
PUBLIC_FNS="hc_resolve hc_resolve_light hc_tree_status hc_tree_remediation hc_changeset_summary hc_review_blocking hc_review_coverage_gap hc_session_changeset_commits hc_session_changeset_files hc_live_task_keys hc_live_review_shas hc_validate hc_state hc_done_state_blocked hc_hash_stdin hc_pkg_probe hc_verification_state hc_is_harness_own_path hc_filter_harness_own hc_cfg hc_read_hook_input hc_has_fn hc_die hc_has_jq hc_require_jq hc_block_categories hc_is_block_category"
